...
?>
    ...
    <div class="specialists" id="specialists">
        <div class="container">
            <div class="title"><?php the_field("title_foto_work"); ?></div>
            <div class="row">
...
<!-- ---------------------------------------------------------------------------------- -->
            <h2 class="subtitle"><?php the_field('123'); ?></h2>
            <div class="toys__wrapper">        
    ...
    <div class="contacts" id="contacts">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="contacts__info">
                        ...
                        <div class="contacts__mail">
                            ...
                            <a href="mail:<?php the_field("mail", 2) ?>"><?php the_field("mail", 2) ?></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                ...
                <?php echo do_shortcode( '[contact-form-7 id="164" title="форма отзывов"]' ); ?>
                </div>
                </div>
            </div>
            <div class="row mt70">
